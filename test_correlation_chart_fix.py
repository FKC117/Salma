#!/usr/bin/env python
"""
Test script to verify the correlation analysis chart fix
"""
...
def test_correlation_chart_fix():
    """Test that the correlation analysis chart fix works"""
    print("Testing correlation analysis chart fix...")
    ...
    try:
        ...
        print(f"Chart type present: {'chart_type' in result}")
        print(f"Data present: {'data' in result}")
        
        # Test creating chart analysis result with the fixed parameters
        ...
        chart_html = result_manager.create_chart_analysis_result(
            ...
            chart_type=result.get('chart_type', 'heatmap'),  # This should now work
            data=result.get('data', data),  # This should now work
        ...
        print("\n🎉 Correlation analysis chart fix verified successfully!")
        return True
        
    except Exception as e:
        print(f"✗ Error during correlation chart fix test: {str(e)}")
        import traceback
        traceback.print_exc()
        return False

if __name__ == "__main__":
    success = test_correlation_chart_fix()
