...
def verify_files():
    ...
    files_to_check = [
        'analytical/analytics/templates/analytics/my_datasets.html',
        'analytical/analytics/views.py',
        'analytical/analytics/urls.py',
        'analytical/analytics/templates/analytics/partials/navbar.html',
        'analytical/analytics/templates/analytics/dashboard.html'
    ]
...
def verify_view_function():
    ...
    views_file = 'analytical/analytics/views.py'
...
def verify_url_pattern():
    ...
    urls_file = 'analytical/analytics/urls.py'
